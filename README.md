# Windows приложение для баз данных – ADO.NET
  Проект создан и представлен как учебный, в котором реализовано приложение для баз данных – ADO.NET, использующий инструментарий MS SQL Management Studio, WinForms, C#
